...
import 'package:entregas/src/models/category.dart';
...
import 'package:entregas/src/provider/categories_provider.dart';
import 'package:entregas/src/provider/products_provider.dart';
...
class RestaurantProductsCreateController {
  ...
  String idCategory; // ARMAZENAR O ID DA CATEGORIA SELCCIONADA
  ...
  void createProduct() async {
    ...
    if (name.isEmpty || description.isEmpty || price == 0) {
      MySnackbar.show(context, 'Deve preencher todos os campos');
      return;
    }

    if (imageFile1 == null || imageFile2 == null || imageFile3 == null) {
      MySnackbar.show(context, 'Selecciona as tres imagens');
      return;
    }

    if (idCategory == null) {
      MySnackbar.show(context, 'Selecciona a categoria do producto');
      return;
    }
  ...
  void showAlertDialog(int numberFile) {
    ...
    AlertDialog alertDialog = AlertDialog(
      title: Text('Selecciona tua imagem'),
      actions: [
        galleryButton,
        cameraButton
      ],
