...
import 'package:entregas/src/pages/client/address/list/client_address_list_controller.dart';
...
class _ClientAddressListPageState extends State<ClientAddressListPage> {
    ...
    return Column(
      children: [
        Container(
            ...
            child: NoDataWidget(text: 'Nao tens nenhuma direcao adiciona uma nova')
        ),
        _buttonNewAddress()
      ],
    );
  ...
  Widget _textSelectAddress() {
    return Container(
      ...
      child: Text(
        'Escolhe onde receber tuas compras',
        style: TextStyle(
            fontSize: 19,
            fontWeight: FontWeight.bold
        ),
