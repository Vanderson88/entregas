import 'package:entregas/src/models/address.dart';
...
import 'package:entregas/src/provider/address_provider.dart';
import 'package:entregas/src/provider/orders_provider.dart';
import 'package:entregas/src/provider/stripe_provider.dart';
...
class ClientAddressListController {
  ...
  void createOrder() async {
    ...
    progressDialog.show(max: 100, msg: 'Espere um momento');

    var response = await _stripeProvider.payWithCard('${16 * 100}', 'USD');
  ...
  Future<List<Address>> getAddress() async {
    ...
    print('GUARDOU-SE A DIRECCAO: ${a.toJson()}');
