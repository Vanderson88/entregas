...
import 'package:entregas/src/pages/client/orders/list/client_orders_list_controller.dart';
                ...
                builder: (context, AsyncSnapshot<List<Order>> snapshot) {
                  ...
                  if (snapshot.hasData) {
                    ...
                    if (snapshot.data.length > 0) {
                      ...
                      return NoDataWidget(text: 'Nao ha ordens');
                    }
                  }
                  else {
                    return NoDataWidget(text: 'Nao ha ordens');
                ...
                child: Column(
                  children: [
                    ...
                    Container(
                      ...
                      margin: EdgeInsets.symmetric(vertical: 5),
                      child: Text(
                        'Entregador: ${order.delivery?.name ?? 'Nao adicionado'} ${order.delivery?.lastname ?? ''}',
                        style: TextStyle(
                            fontSize: 13
                        ),
                        maxLines: 1,
