...
import 'package:entregas/src/pages/delivery/orders/detail/delivery_order_detail_controller.dart';
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              _con.order.status != 'ENTREGUE' ? _buttonNext() : Container()
            ],
          ),
        ),
      ),
    ...
    return Container(
      ...
      child: ElevatedButton(
        ...
        style: ElevatedButton.styleFrom(
            primary: _con.order?.status == 'ENVIADO' ? Colors.blue : Colors.green,
          ...
          children: [
            Align(
              ...
              child: Container(
                ...
                alignment: Alignment.center,
                child: Text(
                  _con.order?.status == 'ENVIADO' ? 'INICIAR ENTREGA' : 'IR AO MAPA',
                  style: TextStyle(
                      fontSize: 16,
                      fontWeight: FontWeight.bold
                  ),
