import 'package:entregas/src/pages/delivery/orders/map/delivery_orders_map_controller.dart';
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              _listTileAddress(_con.order?.address?.neighborhood, 'Bairro', Icons.my_location),
              _listTileAddress(_con.order?.address?.address, 'Direccao', Icons.location_on),
