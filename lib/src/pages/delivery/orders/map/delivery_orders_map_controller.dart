...
import 'package:entregas/src/api/enviroment.dart';
...
class DeliveryOrdersMapController {
  ...
  CameraPosition initialPosition = CameraPosition(
      target: LatLng(8.8318771, 13.2328066),
      zoom: 14
  );
  ...
  void updateToDelivered() async {
    ...
    if (_distanceBetween <= 200) {
      ...
      MySnackbar.show(context, 'Deves estar mais perto da posicao de entrega');
    }
  }
  ...
  void updateLocation() async {
    try {
      await _determinePosition(); // OBTER A POSICAO ACTUAL E TAMBEM SOLICITAR AS PERMISSOES
